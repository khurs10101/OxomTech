    ...
    if(is_logged_in()=="ankit@oxomlab"){
        ...
        if(isset($_COOKIE["action"])) {
            // action already done
                ...
                // run query
                $query_log="INSERT INTO ankit_log (login_time) VALUES(NOW())";
                mysqli_query($con,$query_log);
                
            }
        //ends
        
            $result= mysqli_query($con,"SELECT * FROM ankit_log ORDER BY id DESC LIMIT 1");
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                <img style="width: 150px; height: 150px;" class="rounded-circle" src="img/ankit.jpg" alt="ankit"> 
                            </div> 
                            </div>
                            <div class="col-lg-8">
                   ...
                   <div class="container">
                       <div class="row">
                           <div class="col text-center">
                               <h1 class="display-3 text-center text-muted mt-5">Ankit You are not logged in</h1>
