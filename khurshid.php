<?php
    ...
    if(is_logged_in()=="khurs10101"){
        ...
        $query_log="INSERT INTO khurshid_log (login_time) VALUES(NOW())";
        ...
        //ends
            ...
            $result= mysqli_query($con,"SELECT * FROM khurshid_log ORDER BY id DESC LIMIT 1");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="khurshid.php" class="nav-link">Dashboard</a>
                        </li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                <img style="width: 150px; height: 150px;" class="rounded-circle" src="img/khurshid.jpg" alt="khurshid"> 
                            </div> 
                            </div>
                            <div class="col-lg-8">
                                <div class="mt-4 text-center text-lg-left">
                                    <p>Khurshid Alam Bhuyan</p>
                   ...
                   <div class="container">
                       <div class="row">
                           <div class="col text-center">
                               <h1 class="display-3 text-center text-muted mt-5">Khurshid You are not logged in</h1>
