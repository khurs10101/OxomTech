<?php
    ...
    if(is_logged_in()=="prakash@oxomlab"){
        ...
        if(isset($_COOKIE["action"])) {
            // action already done
                ...
                // run query
                $query_log="INSERT INTO prakash_log (login_time) VALUES(NOW())";
                mysqli_query($con,$query_log);
            }
        //ends
        
            $result= mysqli_query($con,"SELECT * FROM prakash_log ORDER BY id DESC LIMIT 1");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="prakash.php" class="nav-link">Dashboard</a>
                        </li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                <img style="width: 150px; height: 150px;" class="rounded-circle" src="img/prakash.jpg" alt="prakash"> 
                            </div> 
                            </div>
                            <div class="col-lg-8">
                   ...
                   <div class="container">
                       <div class="row">
                           <div class="col text-center">
                               <h1 class="display-3 text-center text-muted mt-5">Prakash You are not logged in</h1>
